                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="row g-1">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_employee_number}}"
                                                                        placeholder="الرقم الوظيفي" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_identity_number}}"
                                                                        placeholder="الرقم الهوية" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_direct_manager}}"
                                                                        placeholder="المدير المباشر" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_basic_salary}}"
                                                                        placeholder="الراتب" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_housing_allowance}}"
                                                                        placeholder="بدل السكن" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_other_allowances}}"
                                                                        placeholder="بدلات اخري" readonly>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input class="form-control text-center"
                                                                        value="{{$employees->employees_birth_date}}"
                                                                        placeholder="تاريخ الميلاد" readonly>
                                                                    </div>
                                                                    <div class="col-md-12">
                                ...
                                <div class="col-12" id="inputCard" style="display: none;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="row g-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-9">
                                                                    <input name="birth_date" type="date" class="form-control text-center" required>
                                                                </div>
                                                                <div class="col-md-3 text-center">
