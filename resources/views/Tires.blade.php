<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <button id="toggleCardViewButton" class="btn btn-primary col-3 pe-2 float-end" onclick="toggleCardView()"> ادخال جديد <i class="fa-solid fa-plus"></i></button>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="card bg-light">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <button type="submit" class="btn btn-success col-3">حفظ <i class="fa fa-bookmark" aria-hidden="true"></i></button>
                                                        <button type="submit"  id="printButton" class="btn btn-primary col-3" onclick="window.print()"><i class="fas fa-print"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-2 d-flex justify-content-end align-items-center">
                                                        <input type="text" class="form-control text-center" id="reference number" value="" placeholder="رقم المرجع">
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                    ...
                                                    <div class="col-md-6 mb-2">
                                                        <input type="text" class="form-control text-center" id="Customer data" value="" placeholder="بيانات العميل">
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <input type="number" class="form-control text-center" id="invoice number" value="" placeholder="رقم الفاتورة" readonly>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                    ...
                                                    <div class="col-md-12 text-end">
                                                        <input type="text" class="form-control text-end" id="Seller name" value="" placeholder="اسم البائع" readonly>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card bg-light">
                                            <div class="card-body">
                                                <div id="addNewItemForm">
                                                    <div class="row g-2">
                                                        <div class="col-md-6">
                                                            <input type="text" name="itemName" id="itemName" required class="form-control text-center" placeholder="اسم الماركة">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="number" class="form-control text-center" id="validationCustom02" placeholder="الرقم التسلسلي" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="number" name="name" required class="form-control text-center" id="quantity" placeholder="الكمية">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="number" name="name" required class="form-control text-center" id="price" placeholder="السعر">
                                                        </div>
                                                        <div class="col-md-12">
                                                            <input type="number" name="Total" id="Total" required class="form-control text-center" placeholder="المجموع">
                                                        </div>
                                                        <div class="footer text-center">
                                                            <button type="button" class="btn btn-danger col-3" data-bs-dismiss="modal">الغاء <i class="fa-solid fa-xmark"></i></button>
                                                            <button type="button" class="btn btn-success col-3" id="addItemBtn">اضافة <i class="fa-solid fa-plus"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="card mb-2 bg-light" style="height: 100%;">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6 mb-2">
                                                        <input type="number" class="form-control text-center" id="Total" value="" placeholder="الاجمالي" readonly>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <input type="number" class="form-control text-center" id="VAT%15" value="" placeholder="ضريبة القيم المضافة%15" readonly>
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <select class="form-select text-center" id="discountType" aria-label="Default select example" onchange="handleDiscountType()">
                                                    ...
                                                    <div class="col-md-6 mb-2" id="percentageDiscountField" style="display: none;">
                                                        <input type="number" class="form-control text-center" id="percentageDiscountValue" placeholder="قيمة الخصم بالنسبة">
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                    <div class="col-md-6 mb-2" id="amountDiscountField" style="display: none;">
                                                        <input type="number" class="form-control text-center" id="amountDiscountValue" placeholder="قيمة الخصم بالمبلغ">
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                    <div class="col-md-6 mb-2">
                                                        <input type="number" class="form-control text-center" id="totalAmountWithTax" value="" placeholder="الاجمالي مع الضريبة" readonly>
                                                    </div>
                                                    <div class="col-md-12 mb-2">
                                                        <input type="number" class="form-control text-center" id="netAmount" value="" placeholder="المبلغ الصافي" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <form class="mb-1" action="" method="post">
                                            <div class="card bg-light">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12 mb-2">
                                                            <input type="text" class="form-control text-center" placeholder="ادخال اطارات جديدة" readonly>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <input type="number" class="form-control text-center" placeholder="الرقم التسلسلي">
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <input type="number" class="form-control text-center" placeholder="المقاس" required>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <input type="number" class="form-control text-center" placeholder="الكمية" required>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <input type="number" class="form-control text-center" placeholder="السعر"required>
                                                        </div>
                                                        <div class="row text-center">
                                                            ...
                                                            <div class="col-md-3 mb-4 text-end">
                                                                <label for="brand" class="form-label inline"> اختار ماركة الاطار</label>
                                                            </div>
                                                            <div class="col-md-3 ms-3">
                                                                <select id="model" class="form-select text-center" aria-describedby="validationServer04Feedback" required>
                                                                    <option value=""></option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-2 mb-4 text-end">
                                                                <label for="model" class="form-label">اختار بلد الاننشاء</label>
                                                            </div>
                                                        </div>
                                                        <div class="row  mb-2">
                                                            <div class="col-md-9">
